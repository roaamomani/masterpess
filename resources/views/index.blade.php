...
<body>
    ...
    <section class="hero-section">
        <div class="hero-items owl-carousel">
            <div class="single-hero-item set-bg" data-setbg="img/hero-slider/GYM33.jpg">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="hero-text">
            ...
            <div class="single-hero-item set-bg" data-setbg="img/hero-slider/GYM4.jpg">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="hero-text">
    ...
    <section class="feature-section">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-4">
                    <div class="feature-item set-bg" data-setbg="img/feature/GYM6.JPG">
                        <h3>GROUP CLASSES</h3>
                        <p>Join our dynamic group classes for an energetic workout experience.</p>
                ...
                <div class="col-md-4">
                    <div class="feature-item set-bg" data-setbg="img/feature/feature-2.jpg">
                        ...
                        <p>Get personalized guidance and support to reach your fitness goals.</p>
                        <a href="#" class="primary-btn f-btn">Read More</a>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="feature-item set-bg" data-setbg="img/feature/feature-3.jpg">
                        ...
                        <p>Discover how nutrition can enhance your athletic performance.</p>
                        <a href="#" class="primary-btn f-btn">Read More</a>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-lg-7 m-auto text-center">
                        <div class="section-title pl-lg-4 pr-lg-4 pl-0 pr-0">
                            <h2>Choose Your Muscle Program</h2>
                            <p>Our CrossFit experts can help you discover new training techniques and exercises that effectively target muscle building.</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-lg-3 col-sm-6">
                    <div class="classes-item set-bg" data-setbg="img/classes/class-1.jpg">
                        <h4>Muscle Building Level 1</h4>
                        <p>A program designed to strengthen core muscles and enhance endurance.</p>
                        <a href="#" class="primary-btn class-btn">Read More</a>
                    </div>
                </div>
                <div class="col-lg-3 col-sm-6">
                    <div class="classes-item set-bg" data-setbg="img/classes/class-2.jpg">
                        <h4>Strength and Endurance Training</h4>
                        <p>An integrated program combining strength and fitness to improve overall performance.</p>
                        <a href="#" class="primary-btn class-btn">Read More</a>
                    </div>
                </div>
                <div class="col-lg-3 col-sm-6">
                    <div class="classes-item set-bg" data-setbg="img/classes/class-3.jpg">
                        <h4>Advanced Strength Training</h4>
                        <p>A specialized program for advanced athletes focusing on muscle-building techniques.</p>
                        <a href="#" class="primary-btn class-btn">Read More</a>
                    </div>
                </div>
                <div class="col-lg-3 col-sm-6">
                    <div class="classes-item set-bg" data-setbg="img/classes/class-4.jpg">
                        <h4>Flexibility and Balance Training</h4>
                        <p>A program that helps improve flexibility and balance while strengthening muscles.</p>
                        <a href="#" class="primary-btn class-btn">Read More</a>
                    </div>
                </div>
            </div>
                ...
                <div class="col-lg-12">
                    <div class="timetable-controls">
                        <ul>
                            ...
                            <li data-tsfilter="strength">Strength Training</li>
                            <li data-tsfilter="endurance">Endurance Training</li>
                            <li data-tsfilter="flexibility">Flexibility Training</li>
                        </ul>
                    </div>
                </div>
            </div>
                ...
                <table>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="hover-bg ts-item" data-tsmeta="strength">
                                <span>10:00 - 12:00</span>
                                <h6>Muscle Building Level 1</h6>
                            </td>
                            <td></td>
                            <td class="hover-bg ts-item" data-tsmeta="strength">
                                <span>10:00 - 12:00</span>
                            ...
                            <td></td>
                            <td class="hover-bg ts-item" data-tsmeta="endurance">
                                <span>10:00 - 11:30</span>
                                <h6>Strength and Endurance Training</h6>
                            </td>
                            <td></td>
                            <td class="hover-bg ts-item" data-tsmeta="endurance">
                                <span>10:00 - 11:30</span>
                        ...
                        <tr>
                            ...
                            <td></td>
                            <td class="hover-bg ts-item" data-tsmeta="flexibility">
                                <span>14:00 - 16:00</span>
                                <h6>Flexibility and Balance Training</h6>
                            </td>
                            <td></td>
                            <td class="hover-bg ts-item" data-tsmeta="strength">
                                <span>14:00 - 16:00</span>
                            ...
                            <td class="hover-bg ts-item" data-tsmeta="strength">
                                <span>14:00 - 16:00</span>
                                <h6>Advanced Strength Training</h6>
                            </td>
                            <td></td>
                        </tr>
                        <tr>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="section-title">
                        ...
                        <p>Explore our flexible pricing plans that cater to your muscle training needs and fitness goals.</p>
                    </div>
            ...
            <div class="row">
                <div class="col-lg-4">
                    <div class="single-price-plan">
                        ...
                        <ul>
                            ...
                            <li>1 muscle-building class per week</li>
                            <li>FREE hydration package</li>
                ...
                <div class="col-lg-4">
                    <div class="single-price-plan">
                        ...
                        <ul>
                            <li>Unlimited access to the gym</li>
                            <li>2 muscle-building classes per week</li>
                            <li>FREE hydration package</li>
                ...
                <div class="col-lg-4">
                    <div class="single-price-plan">
                        ...
                        <ul>
                            <li>Unlimited access to the gym</li>
                            <li>6 muscle-building classes per week</li>
                            <li>FREE hydration package</li>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="section-title">
                        ...
                        <p>Our expert trainers and state-of-the-art equipment create the perfect environment for muscle training.</p>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-4 col-sm-6">
                    <div class="choose-item">
                        ...
                        <h5>24/7 Support</h5>
                        <p>Our team is available around the clock to help you with any questions or concerns.</p>
                    </div>
                </div>
                <div class="col-lg-4 col-sm-6">
                    <div class="choose-item">
                        ...
                        <p>Our certified trainers specialize in muscle building and will guide you every step of the way.</p>
                    </div>
                </div>
                <div class="col-lg-4 col-sm-6">
                    <div class="choose-item">
                        ...
                        <p>Enjoy tailored workout sessions designed to meet your unique fitness goals.</p>
                    </div>
                </div>
                <div class="col-lg-4 col-sm-6">
                    <div class="choose-item">
                        ...
                        <p>Train with the latest equipment designed specifically for muscle growth and strength.</p>
                    </div>
                </div>
                <div class="col-lg-4 col-sm-6">
                    <div class="choose-item">
                        ...
                        <h5>Daily Classes</h5>
                        <p>Participate in daily muscle-building classes that fit your schedule.</p>
                    </div>
                </div>
                <div class="col-lg-4 col-sm-6">
                    <div class="choose-item">
                        <img src="img/icons/chose-icon-6.png" alt="">
                        <h5>Focus on Health</h5>
                        <p>We prioritize your health and wellness, helping you achieve your fitness goals.</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <!-- Cta Section Begin -->
    <sect<section class="cta-section">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="cta-text">
                        <h3>Get Started Today!</h3>
                        <p>New student special! $30 for unlimited gym access in the first week and 50% off your membership!</p>
                    </div>
    ...
    <div class="map">
        ...
        <div class="map-contact-details">
            <div class="open-time">
                <h5>Opening Hours:</h5>
                <ul>
                    <li>Weekdays: <span>06:30 - 11:00</span></li>
            ...
            <div class="row">
                <div class="col-lg-3">
                    <div class="footer-logo-item">
                        ...
                        <p>Despite the growth of the internet over the past few years, the use of toll-free phone numbers in television advertising continues.</p>
                    ...
                    <div class="footer-widget">
                        ...
                        <div class="footer-blog">
                            <a href="#" class="fb-item">
                                <h6>The Importance of Regular Exercise</h6>
                                <span class="blog-time"><i class="fa fa-clock-o"></i> Jan 02, 2019</span>
                            </a>
                            <a href="#" class="fb-item">
                                <h6>Tips for Effective Training</h6>
                                <span class="blog-time"><i class="fa fa-clock-o"></i> Jan 02, 2019</span>
                            </a>
                            <a href="#" class="fb-item">
                                <h6>How to Stay Fit at Home</h6>
                                <span class="blog-time"><i class="fa fa-clock-o"></i> Jan 02, 2019</span>
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="footer-widget">
                        ...
                        <ul class="footer-info">
                            ...
                            <li>
                                ...
                                <span>Email:</span>
                                Strength Hub@gmail.com
                            </li>
                            <li>
                                <i class="fa fa-map-marker"></i>
                                <span>Address:</span>
                                Aqaba, Jordan, P.O. Box 2838562
                            </li>
                        </ul>
                    </div>
                </div>
