                ...
                <div class="col-lg-8">
                    <div class="card shadow-lg border-0">
                        <div class="card-header bg-success text-white text-center">
                            <h3 class="card-title text-white">Edit Training Field - {{ $field->field_name }}</h3>
                        </div>
                        <div class="card-body p-4">
                            ...
                            <form action="{{ route('fields.update', $field->id) }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group mb-3">
                                    <label for="field_name" class="form-label">Training Field Name</label>
                                                ...
                                                <div class="card">
                                                    ...
                                                    <div class="card-body text-center">
                                                        <div class="form-check">
                                                            ...
                                                            <label class="form-check-label text-danger" for="delete_image_{{ $image->id }}"> <i class="fas fa-trash"></i> Delete</label>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <button type="submit" class="btn btn-success btn-lg w-100">Update Training Field</button>
                            </form>
                        </div>
